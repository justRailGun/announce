...
<div className="flex flex-col items-center justify-center"  suppressHydrationWarning>
    ...
    <div className='flex gap-4 justify-center w-full items-center'>
      <Button className="w-full" onClick={()=>signIn("google")} ><Image src="/icons/google.svg" alt="google" className='' width={20} height={20}/></Button>
      <Button className="w-full dark:bg-primary-500" onClick={()=>signIn("github")} ><Image src="/icons/github.svg" alt="github" className='' width={20} height={20}/></Button>
      </div>
  </div>
)
